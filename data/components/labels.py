...
class Button(object):
    def __init__(self, left, top, width, height, label, payload, amount):
    ...
    def draw(self, surface):
       pg.draw.rect(surface, pg.Color("gray70"), self.rect)
       pg.draw.rect(surface, pg.Color("gray10"), self.rect, 2)
